    ...
    <div x-show="menuOpen" class="fixed inset-0 z-[60] flex" x-cloak>
        ...
        <nav x-show="menuOpen" 
            ...
            <div class="flex flex-col py-4 overflow-y-auto">
                ...
                <a href="https://chat.whatsapp.com/DJqF97ZVIxtHEjYDSepyDz?mode=gi_t" target="_blank" rel="noopener noreferrer" class="flex items-center px-6 py-4 m-5 bg-green-500 hover:bg-green-600 text-white rounded-xl font-bold transition-all shadow-md active:scale-95">
