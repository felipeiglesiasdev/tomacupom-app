        ...
        <div class="rounded-2xl transition-all duration-500 ease-in-out border px-6 py-3" :class="{'bg-white/95 backdrop-blur-lg shadow-lg border-gray-200/80': scrolled, 'bg-transparent shadow-none border-transparent': !scrolled }">
            <div class="flex items-center justify-between gap-4 lg:gap-8">
                ...
                >
                    ...
                    <a href="https://chat.whatsapp.com/SEU_LINK_AQUI" target="_blank" rel="noopener noreferrer" class="ml-4 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 py-2.5 rounded-full font-bold transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1">
