{{--
    Rodapé principal do site, fundo #222222, links de navegação,
    informações de copyright, e redes sociais em SVG.
--}}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            <div class="lg:col-span-2 pr-0 lg:pr-8">
                <a href="{{ route('home') }}" class="inline-block mb-6" title="Ir para a página inicial do Toma Cupom">
                    <!-- Usando a versão clara do logo para fundo escuro -->
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-3">
                    <!-- Instagram -->
                    <a href="#" class="group w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-500 hover:border-transparent transition-all duration-300 shadow-sm" aria-label="Instagram">
                    ...
                    <!-- TikTok -->
                    <a href="#" class="group w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-black hover:border-transparent transition-all duration-300 shadow-sm" aria-label="TikTok">
                    ...
                    <!-- WhatsApp Ofertas -->
                    <a href="https://chat.whatsapp.com/SEU_LINK_AQUI" class="group w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-green-500 hover:border-transparent transition-all duration-300 shadow-sm" aria-label="Grupo WhatsApp" title="Grupo de Ofertas no WhatsApp">
                    ...
                    <!-- Telegram Ofertas -->
                    <a href="#" class="group w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-[#0088cc] hover:border-transparent transition-all duration-300 shadow-sm" aria-label="Grupo Telegram" title="Grupo de Ofertas no Telegram">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 16 16">
